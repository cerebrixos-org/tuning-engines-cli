...
exports.createClaudeAgentSdkTraceAdapter = createClaudeAgentSdkTraceAdapter;
const shared_1 = require("./shared");
function hookType(eventName) {
    return `claude.${eventName.replace(/[^a-zA-Z0-9_.-]/g, "_")}`;
}
function createClaudeAgentSdkTraceAdapter(options = {}) {
    ...
    return {
        ...
        recordHook(eventName, payload, metadata) {
